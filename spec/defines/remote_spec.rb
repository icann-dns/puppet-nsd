    ...
    context "on #{os}" do
      ...
      describe 'Change Defaults' do
        context 'ipv4 cidr only' do
          before(:each) { params.merge!(address4: '192.0.2.0/24') }
        ...
        context 'ipv6 cidr only' do
          before(:each) { params.merge!(address4: :undef, address6: '2001:DB8::/48') }
          it { is_expected.to compile }
          it do
            is_expected.to contain_concat__fragment(
              'nsd_pattern_xfr.example.com',
        ...
        context 'tsig_name' do
          before(:each) { params.merge!(tsig_name: 'example_tsig') }
          it { is_expected.to compile }
          it do
            is_expected.to contain_concat__fragment(
              'nsd_pattern_xfr.example.com',
      ...
      describe 'check bad type' do
        ...
        context 'address4' do
          before(:each) { params.merge!(address4: '333.333.333.333') }
          it { is_expected.to raise_error(Puppet::Error) }
        end
        context 'address6' do
