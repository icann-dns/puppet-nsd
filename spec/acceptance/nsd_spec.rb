...
describe 'nsd class' do
  ...
  nsd::zone {
    ...
    describe command('dig +short soa . @127.0.0.1') do
      ...
      its(:stdout) { should match %r{a.root-servers.net. nstld.verisign-grs.com.} }
    end
  ...
  context 'as112' do
    ...
    describe command('dig +short soa empty.as112.arpa @127.0.0.1') do
      its(:exit_status) { should eq 0 }
      its(:stdout) { should match %r{blackhole.as112.arpa. noc.dns.icann.org. 1 604800 60 604800 604800} }
    end
    describe command('dig +short soa 10.in-addr.arpa @127.0.0.1') do
      its(:exit_status) { should eq 0 }
      its(:stdout) { should match %r{prisoner.iana.org. hostmaster.root-servers.org. 1 604800 60 604800 604800} }
    end
